...
class KEPModelLocalSolver:
    def __init__(self, instance: KEPData):
        ...
        #        self.adjacency_matrix[i][j] = self.instance.adjacency_matrix[i][j]
        #for i in range(self.nb_vertices_first, self.nb_vertices):
        #    self.adjacency_matrix[i][i] = 1
        edges = [(5,0), (6,0), (0,2), (1,3), (3,1), (3,2), (2,4), (4,3),(7,7), (8,8), (9,9)]
        for e in edges:
...
#->KEPSolution
        ...
        with localsolver.LocalSolver() as ls:
            ...
            for n in range(self.nb_vertices):
                _weights_array.add_operand(self.model.array(self.adjacency_matrix[n]))
            _altruist_array = self.model.array(self.instance.list_of_altruists)
            ...
            #_edges_array = self.model.array(edges)

            _sequences_weights = [None] * self.nb_lists
